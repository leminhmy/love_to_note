...
class CardDemoItemFood extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(
        children: [
          BlocBuilder<AddItemFoodCubit, AddItemFoodState>(
            buildWhen: (previous, current) =>
            current.reload == AddItemFoodReload.color,
            builder: (context, state) {
              return IconCircleBtn(
                ...
                icon: BlocBuilder<AddItemFoodCubit, AddItemFoodState>(
                  buildWhen: (previous, current) =>
                  current.reload == AddItemFoodReload.image,
                  builder: (context, state) {
          ...
          BlocBuilder<AddItemFoodCubit, AddItemFoodState>(
            buildWhen: (previous, current) =>
            current.reload == AddItemFoodReload.name,
            builder: (context, state) {
              return TextHeader1(
